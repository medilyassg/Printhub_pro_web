    ...
    const SettingsIndex = props => {
        ...
        const validation = useFormik({
            ...
            initialValues: {
                ...
                site: CompanyInfo && CompanyInfo.site || '',
                address: CompanyInfo && CompanyInfo.address || '',
                phone_number: CompanyInfo && CompanyInfo.phone_number,
                idx: CompanyInfo && CompanyInfo.id || '',

                company_size: CompanyInfo && CompanyInfo.company_size || "",
                industry_sector: CompanyInfo && CompanyInfo.industry_sector || "",
                ice: CompanyInfo && CompanyInfo.ice || "",
                tva: CompanyInfo && CompanyInfo.tva || "",
            },
                                            ...
                                            <div>
                                                <Row>
                                                    <Col xs={12} sm={6} className="mb-3">
                                                        <Label className="form-label" htmlFor="name">TVA Number</Label>
                                                        <Input
                                                            name="tva"
                                                            className="form-control"
