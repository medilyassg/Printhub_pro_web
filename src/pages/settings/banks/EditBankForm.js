...
const EditBankForm = props => {
  ...
  const validation = useFormik({
    initialValues: {
      ...
      holder_name: props.bank.holder_name,
      num_rip: props.bank.num_rip,
      cle_rip:props.bank.cle_rip,
      code_swift: props.bank.code_swift
    },
    onSubmit: (values) => props.handleEdit(props.bank.id, values)
  });
          ...
          <CardBody className="">
            <div className="">
              ...
              >
                ...
                <button type="submit" className="btn btn-primary">Edit Bank</button>
