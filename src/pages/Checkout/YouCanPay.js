    ...
    useEffect(() => {
        ...
        const initializePayment = async () => {
            try {
                ...
                ycPay = new YCPay('pub_442288b1-00e6-478d-89b1-a2e41913', {
        ...
        return () => {
            if (ycPay && typeof ycPay.destroy === 'function') {
                ycPay.destroy();
            }
        };
    }, [props.order, props.CompanyInfo, props.logoBase64, props.footerBase64, navigate]);
